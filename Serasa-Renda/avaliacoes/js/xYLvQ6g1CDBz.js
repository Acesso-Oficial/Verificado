...
function toggleButton(buttonNumber) {
  ...
  // Se já houver um botão ativo, remova a classe 'active' do botão anterior
  if (activeButton !== null) {
    buttons[activeButton - 1].classList.remove('active');
  }

  // Verifique se o botão clicado é o mesmo que o ativo, se sim, desative
  if (activeButton === buttonNumber) {
    activeButton = null; // Desativa o botão
  } else {
    // Ativa o botão clicado e atualiza o botão ativo
